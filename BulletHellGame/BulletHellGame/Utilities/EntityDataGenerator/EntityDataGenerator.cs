...
namespace BulletHellGame.Utilities.EntityGenerator
{
    public class EntityDataGenerator
    {
        ...
        {
            EnemyData phase1 = EntityDataGenerator.CreateBossPhase("DoubleCircle.Red", "circular");
            EnemyData phase2 = EntityDataGenerator.CreateBossPhase("DoubleCircle.DarkRed", "zigzag");
