...
using BulletHellGame.Logic.Systems.RenderingSystems;
using System.Linq;
...
namespace BulletHellGame.Logic.Managers
{
    public class SystemManager
    {
        ...
        public SystemManager(GraphicsDevice graphicsDevice)
        {
            ...
            LoadSystems<ILogicSystem>("BulletHellGame.Logic.Systems.LogicSystems");

            // Dynamically load rendering systems
            LoadSystems<IRenderingSystem>("BulletHellGame.Logic.Systems.RenderingSystems", graphicsDevice);
        }
